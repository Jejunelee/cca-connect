    ...
    return (
      ...
      >
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-center text-black text-2xl sm:text-4xl lg:text-5xl font-semibold mb-8 sm:mb-12">Our Main Pillars</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="text-center group cursor-pointer">
              ...
              <p className="text-gray-800 font-medium text-lg sm:text-xl mt-6 sm:mt-8 px-2 transition-all duration-300 group-hover:text-blue-600 group-hover:font-semibold">Food & Bar Menu Development</p>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <p className="text-gray-800 font-medium text-lg sm:text-xl mt-6 sm:mt-8 px-2 transition-all duration-300 group-hover:text-green-600 group-hover:font-semibold">Kitchen & Bakery Training</p>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <p className="text-gray-800 font-medium text-lg sm:text-xl mt-6 sm:mt-8 px-2 transition-all duration-300 group-hover:text-purple-600 group-hover:font-semibold">Culinary, Hospitality, and Management Training Development</p>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <p className="text-gray-800 font-medium text-lg sm:text-xl mt-6 sm:mt-8 px-2 transition-all duration-300 group-hover:text-orange-600 group-hover:font-semibold">Service Design</p>
            </div>
