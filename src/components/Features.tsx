      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <ul className="space-y-6 text-2xl text-gray-800">
            <li className="flex gap-4 items-start group cursor-pointer transition-all duration-300 hover:translate-x-2">
              <img 
                src="/icons/1.png" 
                alt="Experts" 
                className="w-14 h-14 mt-1 transition-all duration-300 group-hover:scale-110 group-hover:translate-x-1" 
              />
              <ul
                className="list-disc list-inside space-y-1 text-gray-700 ml-2 transition-all duration-300 group-hover:translate-x-2"
                style={{ fontFamily: 'var(--font-jost), sans-serif' }}
              >
            ...
            <li className="flex gap-4 items-start group cursor-pointer transition-all duration-300 hover:translate-x-2">
              <img 
                src="/icons/4.png" 
                alt="Management" 
                className="w-12 h-12 mt-8 transition-all duration-300 group-hover:scale-110 group-hover:translate-x-1" 
              />
              <div 
