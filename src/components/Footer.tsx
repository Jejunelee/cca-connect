        ...
        <div style={containerStyles}>
          ...
          <div style={contentStyles}>
            ...
            <div style={linksSectionStyles}>
              ...
              <ul style={linksListStyles}>
                ...
                <li><a href="/blog" style={linkStyles}>Blog</a></li>
              </ul>
            </div>
            ...
            <div style={linksSectionStyles}>
              ...
              <ul style={linksListStyles}>
                <li><a href="/help" style={linkStyles}>Help Center</a></li>
                <li><a href="/privacy" style={linkStyles}>Privacy Policy</a></li>
                <li><a href="/terms" style={linkStyles}>Terms of Service</a></li>
          ...
          <div style={bottomBarStyles}>
            ...
            <div style={legalLinksStyles}>
              ...
              <a href="/terms" style={legalLinkStyles}>Terms of Service</a>
              <span style={separatorStyles}>•</span>
              <a href="/cookies" style={legalLinkStyles}>Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
